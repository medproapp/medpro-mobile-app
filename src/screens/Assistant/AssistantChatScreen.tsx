...
export const AssistantChatScreen: React.FC = () => {
  ...
  const activeSession = useAssistantActiveSession();
  ...
  const handleActionPress = useCallback(async (action: ActionButton) => {
    switch (action.type) {
      ...
      <View key={message.id} style={styles.messageContainer}>
        ...
        >
          ...
          {isUser ? (
            ...
            <Markdown style={getMarkdownStyles(isError)}>
              {message.content}
            </Markdown>
          )}
          <Text
              ...
              {message.metadata.actions.map((action, index) => (
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.actionText,
                      styles[`${action.style}Text` as keyof typeof styles],
                    ]}
                  >
                    {action.text}
                  </Text>
